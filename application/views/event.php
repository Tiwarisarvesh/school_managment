            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                <div class="row event-inner-wrapper">
                    ...
                    <div class="col-lg-12 col-md-6 col-sm-12 col-xs-6">
                        <div class="single-item">
                            <div class="item-img">
                                <a href="#"><img src="<?php echo base_url() ?>assets/user/img/event/2.jpg" alt="event"
                                        class="img-responsive"></a>
                            </div>
                            <div class="item-content">
                                <h3 class="sidebar-title"><a href="#">WordPress MeetUp Conference 2017</a></h3>
                    ...
                    <div class="col-lg-12 col-md-6 col-sm-12 col-xs-6">
                        <div class="single-item">
                            <div class="item-img">
                                <a href="#"><img src="<?php echo base_url() ?>assets/user/img/event/3.jpg" alt="event"
                                        class="img-responsive"></a>
                            </div>
                            <div class="item-content">
                                <h3 class="sidebar-title"><a href="#">WordPress MeetUp Conference 2017</a></h3>
                    ...
                    <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                        <div class="single-item">
                            <div class="item-img">
                                <a href="#"><img src="<?php echo base_url() ?>assets/user/img/event/4.jpg" alt="event"
                                        class="img-responsive"></a>
                            </div>
                            <div class="item-content">
                                <h3 class="sidebar-title"><a href="#">WordPress MeetUp Conference 2017</a></h3>
