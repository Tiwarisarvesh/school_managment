...
<!-- Mirrored from www.radiustheme.com/demo/html/academics/academics/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Mar 2021 07:43:55 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="<?php echo base_url() ?>assets/user/image/x-icon" href="img/favicon.png">
    <!-- Normalize CSS -->
    ...
    <!-- Owl Caousel CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/user/vendor/OwlCarousel/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/user/vendor/OwlCarousel/owl.theme.default.min.css">
    <!-- Main Menu CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/user/css/meanmenu.min.css">
    <!-- nivo slider CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/user/vendor/slider/css/nivo-slider.css"
        type="text/css" />
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/user/vendor/slider/css/preview.css" type="text/css"
        media="screen" />
    <!-- Datetime Picker Style CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/user/css/jquery.datetimepicker.css">
    <!-- Magic popup CSS -->
    ...
    <!-- ReImageGrid CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/user/css/reImageGrid.css">
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/user/style.css">
    <!-- Modernizr Js -->
    <script src="<?php echo base_url() ?>assets/user/js/modernizr-2.8.3.min.js"></script>
</head>
                                ...
                                <div class="header-top-left">
                                    <div class="logo-area">
                                        <a href="index.html"><img class="img-responsive"
                                                src="<?php echo base_url() ?>assets/user/img/logo-primary.png"
                                                alt="logo"></a>
                                    </div>
                                </div>
                            </div>
