    ...
    <div class="dashboard-content-one">
        ...
        <div class="card height-auto">
            <div class="card-body">
                ...
                <form class="new-added-form" method="POST" action="<?php echo base_url() ?>category/insert">
                    <div class="row">
                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                            <label>Category</label>
                            <input type="text" name="category" placeholder=""
                                class="form-control <?php echo (form_error('category') != "" ) ?'is-invalid' : '' ; ?>"
